...
import { ChevronDownIcon, CircleArrowDown, CircleArrowUp } from "lucide-react"
...
export default function EditTransactionDialog({
  ...
  React.useEffect(() => {
    if (transaction) {
      ...
      // Converter tipo da API (INCOME/EXPENSE) para o tipo do form (income/expense)
      const transactionType = transaction.type === "INCOME" ? "income" : "expense"
      setTab(transactionType as TransactionType)
    }
  }, [transaction])
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-106">
        <DialogHeader>
          <DialogTitle>
            Editar {tab === "expense" ? "Despesa" : "Receita"}
          </DialogTitle>
          <DialogDescription>
